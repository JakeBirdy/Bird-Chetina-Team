...
//    private boolean blocked;
        locations[0][0] = new Location("apartment complex, no one's around", 0, 0, false, 'A', false);
        ...
        locations[1][0] = new Location("Apartment", 1, 0, false, '@', false);
        locations[1][1] = new Location("Apartment", 1, 1, false, '@', false);
        locations[1][2] = new Location("Apartment", 1, 2, false, '@', false);
        locations[1][3] = new Location("Apartment", 1, 3, false, '@', false);
        locations[1][4] = new Location("Apartment", 1, 4, false, '@', false);
        locations[2][0] = new Location("Apartment", 2, 0, false, '@', false);
        ...
        locations[2][4] = new Location("Apartment", 2, 4, false, '@', false);
        ...
        locations[4][2] = new Location("Apartment", 4, 2, false, '@', false);
        locations[4][3] = new Location("Apartment", 4, 3, false, '@', false);
        locations[4][4] = new Location("Apartment", 4, 4, false, '@', false);
